...
public class QLSVView extends JFrame {
	...
	public QLSVView() {
		...
		JMenuItem mmClose = new JMenuItem("Close");
		mmClose.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		mnNewMenu.add(mmClose);
		...
		JMenu mmAbout = new JMenu("About");
		mmAbout.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		menuBar.add(mmAbout);
		
		JMenuItem mmAbout1 = new JMenuItem("About Me");
		mmAbout1.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		mmAbout.add(mmAbout1);
		...
		textField_diem1.setBounds(582, 332, 245, 40);
