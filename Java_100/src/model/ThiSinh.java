...
public class ThiSinh implements Serializable {
	...
	public ThiSinh(int maThiSinh, String tenThiSinh, Tinh tinh, Date ngaySinh, boolean gioiTinh, float diemMon1,
	...
	public String toString() {
		return "ThiSinh [maThiSinh=" + maThiSinh + ", tenThiSinh=" + tenThiSinh + ", tinh=" + tinh + ", ngaySinh="
	...
	@Override
	public int hashCode() {
		return Objects.hash(diemMon1, diemMon2, diemMon3, gioiTinh, maThiSinh, ngaySinh, tenThiSinh, tinh);
	}
	...
	public boolean equals(Object obj) {
		...
		return Float.floatToIntBits(diemMon1) == Float.floatToIntBits(other.diemMon1)
				...
				&& Objects.equals(tenThiSinh, other.tenThiSinh) && Objects.equals(tinh, other.tinh);
	}
